    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("user/register", "user/login", "/","/oauth2/**","/login/oauth2/**","/api/videos/upload","/api/images/upload","/api/media/upload/images","/api/media/upload/video").permitAll()  // Allow these endpoints to be accessed without authentication
