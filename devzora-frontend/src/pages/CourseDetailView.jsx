...
import '../css/course/CourseDetailView.css'; // Import the CSS file for styling
import {
    FaStar,
    FaClock,
    FaUserGraduate,
  ...
  return (
    ...
    <div className="course-details-header">
      ...
      <div className="course-main">
        ...
        <img src={"https://online.stanford.edu/sites/default/files/styles/widescreen_tiny/public/2018-03/cs_programminglanguage_cs242.jpg?h=66807ab2&itok=AAMwVPxF"} alt="Course Thumbnail" className="course-thumbnail" />
